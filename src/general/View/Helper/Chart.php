...
class View_Helper_Chart
{
     ...
     */
    private function generate($title, $series, $type, $options = [], $exit = true)
    {
     ...
     * @param exit =true si se debe terminar el script, =false si no se debe terminar
     */
    public function vertical_bar($title, $series, $options = [], $exit = true)
    {
     ...
     * @param exit =true si se debe terminar el script, =false si no se debe terminar
     */
    public function horizontal_bar($title, $series, $options = [], $exit = true)
    {
