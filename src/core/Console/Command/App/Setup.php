...
/**
 * Comando para inicializar la aplicación después de la instalación.
 *
 * Este comando permite crear la estructura de directorios necesaria,
 * establecer permisos y realizar cualquier otra configuración inicial.
 *
 * ## Ejemplos de uso:
 *
