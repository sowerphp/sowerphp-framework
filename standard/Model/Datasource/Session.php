...
// Clase utilizada por esta clase
...
class Session {
	...
	public static function start() {
		// Prefijo para los datos en la sesión (esto permite múltiples
		// sesiones en una misma sesión (confuso, lo sé...)
	...
	public static function delete($name) {
		...
		if (self::check($name)) {
			self::_overwrite($_SESSION, Set::remove(
				$_SESSION,
				self::$_prefix.$name
			));
